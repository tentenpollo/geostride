...
from geostride.models import Coordinate, ExecuteRequest, VibeWeights
...
def main():
    parser = argparse.ArgumentParser(
        description="GeoStride CLI - Generate walking routes from the command line"
    )
    ...
    parser.add_argument(
        ...
        help="Walk duration in minutes (default: 30)"
    )
    parser.add_argument(
        "--greenery", type=float, default=0.5,
        help="Greenery vibe (0-1, default: 0.5)"
    )
    parser.add_argument(
        "--safety", type=float, default=0.5,
        help="Safety vibe (0-1, default: 0.5)"
    )
    parser.add_argument(
        "--quietness", type=float, default=0.5,
        help="Introvert mode vibe (0-1, default: 0.5)"
    )
    parser.add_argument(
        "--liveliness", type=float, default=0.5,
        help="Extrovert mode vibe (0-1, default: 0.5)"
    )
    parser.add_argument(
        "--output", type=str, default="route.geojson", help="Output GeoJSON file"
    )
